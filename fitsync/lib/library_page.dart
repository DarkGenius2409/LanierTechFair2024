    ...
    return StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return workouts.isNotEmpty
                            ...
                            for (var j = 0; j < doc["usedBy"].length; j++) {
                              ...
                              if (j == workouts[index].usedByIndex) {
                                usedBy.add({
                                  ...
                                  "isFav": currentUserPref["isFav"] == false
                                      ? true
                                      : false
                                });
                              } else {
                                        ...
                                        onPressed: () async {
                                          ...
                                          for (var i = 0;
                                            ...
                                            if (currentUserPref["email"] !=
                                              ...
                                              usedBy.add(UserPreference(
                                                  email:
                                                      currentUserPref["email"],
                                                  isFav:
                                                      currentUserPref["isFav"]
                                                          as bool));
                                              updatedUsedBy.add({
                                                "email":
                                                    currentUserPref["email"],
                                          ...
                                          dbRef.doc(workouts[index].id).update(
              ...
              : const Center(
                  child:
                      Text("Look's like you haven't saved any workouts yet"));
        });
  }
}
